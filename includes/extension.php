	...
	public function getFunctions()
	{
		return array(
			...
			'auth_check'        => new Twig_Function_Function('Auth::check'),
                        'screen_name'       => new Twig_Function_Function('Auth::get_screen_name'),
                    
                        'num_format_bytes'  => new Twig_Function_Function('Num::format_bytes'),
		);
	}
